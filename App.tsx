...
import BookingDetailsScreen from './src/screens/dashboardScreens/homeScreen/bookingScreen/bookingDetailsScreen/bookingDetailsScreen';
      ...
      children={
        <NavigationContainer theme={appTheme.dark ? themes.dark : themes.light}>
          <Stack.Navigator
            ...
            <Stack.Screen
              name={routeKeys.BOOKINGDETAILSKEY}
              children={BookingDetailsScreen}
              options={{
                headerTitle: '',
              }}
            />
